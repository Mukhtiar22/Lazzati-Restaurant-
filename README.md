...
This application is built using **React**, translating the rich architectural lines and traditional flavors of the Indus Valley into a modern, minimalist digital experience.
...
- **Color:** Rich Terracotta Orange (`#c35a33`), Warm Sand (`#fcf9f3`), and Umber Charcoal (`#14110f`) dark elements.
